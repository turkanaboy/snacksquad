...
select lives_ok(
  $$select public.upsert_catalog_snack('Cheez-It Original', 'Cheez-It', '024100705509', 'Grains/Bakery', array['Crackers'], null, 'https://fdc.nal.usda.gov/fdc-app.html#/food-details/1/nutrients', null, true)$$,
...
select lives_ok(
  $$select public.upsert_catalog_snack('Cheez-It Changed Upstream', 'Cheez-It', '00024100705509', 'Other', array['en:snacks'], null, null, null, false)$$,
