...
const client={rpc:async(name:string,params?:unknown)=>{calls.push({name,params});if(name==="fantasy_feature_state")return{data:{enabled:false,weeksObserved:1,dailyActiveUsers:2,fullBracketParticipation:false,weeklyUserGrowth:true,averageLogsPerUserWeek:2.5},error:null};if(name==="my_fantasy_leagues")return{data:[{league_id:"l1",name:"Crunch Club",join_code:"abc",member_count:4,is_creator:true}],error:null};if(name==="fantasy_overview")return{data:{league:{id:"l1",name:"Crunch Club",join_code:"abc"},members:[],season:{id:"s1",season_number:2,status:"active",current_pick:21,pick_deadline:null,scoring_starts_at:"2026-07-13T04:00:00Z",scoring_ends_at:"2026-07-25T04:00:00Z",completed_at:null},draftOrder:[],picks:[],roster:[],standings:[],archive:[{season:{id:"s0",season_number:1,status:"complete",current_pick:21,pick_deadline:null,scoring_starts_at:"2026-06-15T04:00:00Z",scoring_ends_at:"2026-06-27T04:00:00Z",completed_at:"2026-06-27T04:00:00Z"},members:[{user_id:"u1",display_name:"Alex"}],roster:[{user_id:"u1",snack_id:"apple",snack_name:"Apple",category:"Fruit"}],standings:[{user_id:"u1",points:9}]}]},error:null};return{data:"l1",error:null};}};
...
assert.deepEqual(overview.archive[0],{
  season:{ id:"s0", seasonNumber:1, status:"complete", currentPick:21, pickDeadline:null, scoringStartsAt:"2026-06-15T04:00:00Z", scoringEndsAt:"2026-06-27T04:00:00Z", completedAt:"2026-06-27T04:00:00Z" },
  members:[{ userId:"u1", displayName:"Alex" }],
  roster:[{ userId:"u1", snackId:"apple", snackName:"Apple", category:"Fruit" }],
  standings:[{ userId:"u1", points:9 }],
});
