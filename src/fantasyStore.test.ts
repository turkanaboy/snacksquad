...
import { easternMonthStart,getFantasyFeatureState,getMyFantasyLeagues,getFantasyOverview,joinFantasyLeague } from "./fantasyStore";
...
assert.equal(easternMonthStart(new Date("2026-08-01T01:00:00Z")),"2026-07-01");
assert.equal(easternMonthStart(new Date("2026-08-01T05:00:00Z")),"2026-08-01");
